...
This fork changes the expression passed to `sed` because (at least on macOS) the URL built for GitHub links end up looking like: `https://github.com/'user/repo'`. In this fork they appears as `https://github.com/user/repo`.
